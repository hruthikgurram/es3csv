...
# es3csv - A port of es2csv to Python 3
# https://github.com/taraslayshchuk/es2csv

# Tell pylint to suppress line-too-long warnings.
# pylint: disable=C0301

"""
title:          A CLI tool for exporting data from Elasticsearch into a CSV file.
description:    Command line utility, written in Python, for querying Elasticsearch in Lucene query
                syntax or Query DSL syntax and exporting result as documents into a CSV file.
